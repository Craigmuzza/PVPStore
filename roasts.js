...
const roastsByLang = {
  ...
  london: [
    ...
    "{name}, you're the human equivalent of an Oyster card that's been topped up and lost — wasted potential nobody mourns.",
    "Even the rats in the Underground would gentrify away from your bloodline.",
    "Your future is a damp basement flat in Croydon and a microwave meal for one.",
    "You're what happens when a Pret meal deal gains sentience and learns to disappoint.",
    "If London is the city that never sleeps, your career has been comatose since birth.",
    "{name}, the Thames has carried better cargo than your DNA.",
    "Your obituary will be a single tweet that nobody likes.",
    "You've got the personality of a closed Wetherspoons toilet in Leicester Square.",
    "Even the Tower of London ravens look at you like you're bad luck.",
    "Your love life has the same energy as the Embankment at 4am — wet, sad, and full of strangers.",
    "If you fell on the Tube tracks, the only thing delayed would be everyone's relief.",
    "Your bloodline is one of the few things Boris was right to want a bridge over.",
    "The only thing you'll ever lead is a foreign exchange student into the wrong postcode.",
    "{name}, even the lift at Covent Garden moves with more purpose than you've ever had.",
    "Your existence is what the congestion charge was secretly designed to discourage.",
  ],
  ...
  manchester: [
    ...
    "{name}, your mum's WhatsApp status is 'married for the visa' and even that's a step up from you.",
    "You're what's left in the Northern Quarter alley after the bins are emptied.",
    "Even the wet stone of the Whitworth has more colour than your soul.",
    "Your DNA tested positive for nothing but disappointment and rainwater.",
    "If Madchester was a state of mind, your bloodline is the comedown.",
    "{name}, the only Ferrari you'll ever sit in is a Hot Wheels you nicked from Smyths in 2007.",
    "Your mum's most successful relationship was with the Bury bus.",
    "Even Stockport doesn't want to claim you, and Stockport will take anyone.",
    "Your face has appeared on more BBC North West crime reconstructions than the actual suspect.",
    "If they buried you under Old Trafford, the curse would finally lift.",
    "You're the reason Failsworth got its name.",
    "Your dad nipped to the offie in '94 and the only thing he came back with was relief.",
    "Even Salford Quays at high tide wouldn't take you back.",
    "{name}, you make Piccadilly Gardens look like Versailles.",
    "The Mancunian Way has carried millions. Your mother more.",
  ],
  ...
  liverpool: [
    ...
    "{name}, your scouse accent is the most charming thing about you and even that's grating.",
    "Your mum's been on Hope Street more times than the parishioners.",
    "You're what they sweep off the Albert Dock at 5am on a Sunday.",
    "Even the dockers in the '80s had more dignity than you've shown in your entire life.",
    "Your dad emigrated to Ireland to escape the disappointment and he STILL won't pick up.",
    "If they did DNA tests on your family, they'd find Liverpool and several cousins.",
    "{name}, the closest you'll get to a Premier League trophy is washing one in a museum gift shop.",
    "Your future is selling lukewarm beer outside Anfield and dying of liver disease at 47.",
    "You've got the IQ of a Halfords tyre and the charisma of a Birkenhead bus stop.",
    "Even the Beatles broke up trying to avoid your bloodline.",
    "Your mum's pulled more on Bold Street than any of the bouncers.",
    "The Cavern Club has hosted legends. Your house has hosted bailiffs.",
    "{name}, even the Yellow Submarine wouldn't take you on a one-way trip.",
    "You couldn't pull a pint at the Cavern, let alone a partner.",
    "Your existence is what the Mersey was trying to wash out.",
  ],
  ...
  glasgow: [
    ...
    "{name}, ye look like ye were born in a Buckie bottle and raised on benefits.",
    "Your face has been on 'have you seen this person?' posters all over Govan.",
    "Even the bouncers at the Sub Club wouldn't let your soul in.",
    "You're the reason the Glasgow effect is a thing — life expectancy drops just lookin at ye.",
    "Your maw's been roond Possil more times than the polis.",
    "If they made a documentary about your life, it would air on Channel 5 between two true-crime reruns.",
    "Even the lassies on Sauchiehall Street at 3am would clock you and walk faster.",
    "{name}, the closest you'll get to glory is the Buckfast aisle at Tesco Maryhill.",
    "Your da went oot for a kebab in '88 and the only sound was relief.",
    "You couldn't fight your way out of a Glasgow kiss, let alone deliver one.",
    "Your bloodline runs thinner than the broth in a Sighthill chippy.",
    "Even the Necropolis has more life than you.",
    "If Glasgow has heart, you're the bypass surgery it desperately needs.",
    "{name}, your Tinder bio is a missing persons report nobody filed.",
    "Your funeral cortege will fit in a Yaris and three of the seats will be empty.",
  ],
  ...
  bristol: [
    ...
    "{name}, you're the reason St Pauls has trust issues.",
    "Your maw's been roond more of Stokes Croft than the buskers.",
    "Even the suspension bridge wouldn't catch you if you jumped, it'd just look the other way.",
    "You're what happens when Banksy paints a wall and someone scrubs it off — gone and unmissed.",
    "Your gameplay belongs in the Bristol Old Vic — as a tragedy.",
    "{name}, the only thing flatter than your DPS is your future.",
    "Your dad took the M5 south in '99 and the entire Westcountry breathed easier.",
    "You've got the energy of a damp sofa on Stapleton Road.",
    "Even the cider in the Tobacco Factory tastes less rancid than your personality.",
    "You're the reason the Bristol Sound died — your bloodline killed the mood.",
    "Your mum's been round Lawrence Hill more times than the bin lorry.",
    "If they cremated you on the Downs, the locals would think it was just another illegal BBQ and complain to the council.",
    "{name}, you make Hartcliffe look upmarket.",
    "Even the gulls at Cabot Circus look at you and lose their appetite.",
    "Your love life has the same trajectory as the SS Great Britain — sunk decades ago and unsalvageable.",
  ],
  ...
  cardiff: [
    ...
    "{name}, your boyo accent doesn't make you charming, just tragic in stereo.",
    "Even the Severn Bridge would refuse you toll-free passage.",
    "Your maw's been roond Cardiff Bay more times than the seagulls.",
    "You're what gets washed up at Penarth after a storm.",
    "Even the Brains brewery couldn't manufacture enough beer to make you tolerable.",
    "{name}, the closest you'll come to scoring is the rugby — and even then, only on the telly.",
    "Your dad took the train back to London in '92 and the only thing left behind was relief.",
    "You've got the future of a Saturday night bouncer outside Walkabout — pointless and slowly dying.",
    "Even Cardiff Castle wouldn't have you on a portcullis dropped at full speed.",
    "Your mum's been on Caroline Street more often than chips have.",
    "The Principality Stadium has held legends. Your bedroom has held only your own tears.",
    "{name}, you make Newport look aspirational.",
    "Your bloodline is so thin even Tom Jones wouldn't sing about it.",
    "Even the dragon on the flag spits at the sight of you.",
    "Your funeral will be the Bay's quietest event since the Doctor Who studio shut.",
  ],
  ...
  sheffield: [
    ...
    "{name}, you've got the soul of a closed-down steel mill — cold, hollow, and forgotten.",
    "Your maw's been roond West Street more times than the kebab van.",
    "Even the Henderson's Relish bottle has more sting than you.",
    "You're what happens when the Crucible audience collectively gives up.",
    "Even the trams on the supertram network move with more purpose than your DNA.",
    "{name}, your future is night-shift security at Meadowhall and dying alone in a flat above Iceland.",
    "Your dad caught the train to Doncaster in '97 and the relief on his face is still echoing across South Yorkshire.",
    "Even the seagulls at the pond on Endcliffe Park have a better eulogy written for them.",
    "The Steel City forged legends. Your mum forged your birth certificate.",
    "You've got the charm of a knife arch outside a Sheffield nightclub.",
    "{name}, even Park Hill flats had a glow-up before you ever will.",
    "Your bloodline is so weak the Don couldn't carry it five feet.",
    "Even Pulp's saddest songs are happier than your Tinder bio.",
    "If they cast you in The Full Monty, the audience would walk out before you got to the hat.",
    "Your existence is the reason Henderson's tastes bitter.",
  ],
  ...
  edinburgh: [
    ...
    "{name}, ye look like ye were born in a Royal Mile gutter and raised on tour-guide spit.",
    "Your maw's been roond the Cowgate more times than the polis at chucking-out time.",
    "Even the ghosts on the Mary King's Close tour wouldn't haunt your house — too depressing.",
    "You're what the buskers on Princes Street busk away from.",
    "Your dad nipped to Leith in '89 and the whole city felt better.",
    "{name}, the closest you'll get to the castle is sleeping in the bins at the bottom of the rock.",
    "You've got the future of a Fringe flyerer who never got the joke.",
    "Even Hibs and Hearts fans agree — you're an embarrassment to both.",
    "Your face belongs on the cover of a Trainspotting reboot — the bit that didn't survive.",
    "The Royal Mile sees a million tourists. Your mum's seen the same demographic.",
    "{name}, even the New Town wouldn't claim ye and they think they're better than everyone.",
    "Your bloodline is what Trainspotting was warning everyone about.",
    "Even Arthur's Seat would shrug you off.",
    "Your existence is the reason the Festival closes in August — it's been carrying you for too long.",
    "If the Forth Bridge were honest, it'd just be a giant pointer at your house.",
  ],
  ...
  belfast: [
    ...
    "{name}, you've got the future of a Black Cab tour driver who's run out of jokes.",
    "Your maw's been roond the Holylands more times than the students.",
    "Even the murals on the Falls Road have more soul than your TikTok feed.",
    "You're what they swept up at the Cathedral Quarter at 4am on a Sunday.",
    "Even the Titanic Quarter's centrepiece had a more dignified ending than your bloodline will.",
    "{name}, your future is a Wetherspoons on Royal Avenue and a flat above a chippy in Carrickfergus.",
    "Your dad slipped down to Larne in '93 and the ferry crew gave him a discount for the relief.",
    "Even the peace walls would put a section through your DNA.",
    "You've got the charm of a Glentoran–Linfield handshake.",
    "The shipyard built the Titanic. Your mum built a body count and even that sank.",
    "{name}, even Lisburn wouldn't claim you and they take everyone.",
    "Your bloodline is what George Best was trying to drink away.",
    "Even Stormont produces more than your household.",
    "If you fell into the Lagan, the only thing that would float is the relief on everyone's faces.",
  ...
  nottingham: [
    ...
    "{name}, you're what Robin Hood would have left in the forest if he could.",
    "Your maw's been roond the Market Square more times than the riot vans.",
    "Even the lions on Council House steps would maul you before letting you past.",
    "You're what gets scraped off the floor at Rock City at 4am.",
    "Your dad caught the train to Derby in '95 and even Derby felt like an upgrade.",
    "{name}, the only thing you'll inherit from Nottingham is a knife crime statistic.",
    "You've got the future of a Goose Fair toilet attendant — surrounded by sick and going nowhere.",
    "Even the council estates of St Anns would file a noise complaint against your breathing.",
    "Your bloodline is what the Sheriff was trying to outlaw.",
    "The Castle has dungeons less depressing than your bedroom.",
    "{name}, even Mansfield wouldn't have you and they will literally take anyone.",
    "Your existence is why Boots had to leave Nottingham — they couldn't make a cream for your kind.",
    "Even the buskers on Old Market Square pack up when they see you coming.",
    "If they put you on a Forest scarf, the team would relegate themselves on purpose.",
    "Your love life is the Trent — slow, brown, and full of things nobody asked for.",
  ],
  ...
  southampton: [
    ...
    "{name}, you're the reason the Titanic looks like the lucky one — at least it left.",
    "Your maw's been roond Bevois Valley more times than the takeaway lads on bikes.",
    "Even the Itchen Bridge wouldn't take you both ways.",
    "You're what gets washed up at Mayflower Park after a stag do.",
    "Your dad got on a cruise ship in '99 and the only thing he packed was relief.",
    "{name}, your future is a Greggs on Above Bar and a one-bed above a Greggs on Above Bar.",
    "Even St Mary's would relegate you to non-league family member.",
    "You've got the future of a P&O steward fired for being too miserable.",
    "Your bloodline is what made the Titanic captain keep going — even an iceberg seemed kinder.",
    "Even Portsmouth wouldn't have you, and that's a low low bar.",
    "{name}, your love life has gone down with more ships than the Solent.",
    "Your face is the reason the QE2 retired early.",
    "Even the gulls at the dockyard look at you like you owe them money.",
    "If they cremated you on the Common, the joggers would just thank you for the warmth.",
    "Your existence is why Southampton doesn't even feature in Maritime Quarter history books.",
  ],
  ...
  brighton: [
    ...
    "{name}, you've got the future of a North Laine busker who doesn't know any songs.",
    "Your maw's been roond West Street more times than the hen dos.",
    "Even the gulls at the Pier would shit on your bloodline for being unworthy.",
    "You're what gets washed up at low tide near the burnt-out West Pier.",
    "Your dad caught the train back to Hove in '01 and the difference in property value spoke volumes.",
    "{name}, your future is selling vintage tat in the Lanes that nobody wants — including you.",
    "Even the doughnut stand on the seafront has more substance than your soul.",
    "You've got the energy of an AirBnB-ed seaside flat — emptied out, weekendly used, fundamentally vacant.",
    "Your bloodline is what the Brighton Pavilion mocks every day with its existence.",
    "Even the i360 would refuse to elevate you.",
    "{name}, the only club you'll get into is the depression one and even there you're a bottom-tier member.",
    "Your face belongs on the side of the burnt West Pier — picturesque only because it's wrecked.",
    "If they buried you on the beach, the seagulls would dig you up just to drop you further out at sea.",
    "Even the stoners on Hove Lawns wouldn't share a joint with you.",
    "Your existence is the only thing Brighton has ever been ashamed of.",
  ],
  ...
  plymouth: [
    ...
    "{name}, your future is a deckhand on a fishing boat that's slowly sinking — like your prospects.",
    "Your maw's been roond Union Street more times than the sailors.",
    "Even the Hoe doesn't want you on it and Drake himself would push you off.",
    "You're what gets dredged up at the Barbican on a Sunday morning.",
    "Your dad got on the ferry to Roscoff in '94 and even the French were like 'merci, garde-le'.",
    "{name}, your future is a Wetherspoons on Mayflower Steps and dying of liver disease overlooking the Sound.",
    "Even Argyle would relegate you to the supporters' club car park.",
    "You've got the charm of a closed-down Co-op in Devonport.",
    "Your bloodline is what the Pilgrims left England to get away from.",
    "Even the Eden Project wouldn't take a cutting from your family tree.",
    "{name}, the only thing more depressing than Plymouth is Plymouth with you in it.",
    "Your existence is why the Mayflower kept sailing — they could see you on the shoreline waving.",
    "Even Cornwall wouldn't want you and they put pasties on the regional menu.",
    "If they put your ashes in the Sound, the seabed would politely reject them.",
    "Your face has appeared on more 'have you seen this man' segments on Spotlight than the actual suspects.",
  ],
  ...
  york: [
    ...
    "{name}, you've got the future of a ghost-tour guide who can't even scare the kids.",
    "Your maw's been roond Coney Street more times than the buskers.",
    "Even the Minster crypts have a more vibrant social life than you.",
    "You're what gets swept off the Shambles after a Friday night.",
    "Your dad caught the train to Leeds in '98 and the relief was visible from the Wall.",
    "{name}, your future is a Greggs on Parliament Street and a flatshare in Tang Hall.",
    "Even Clifford's Tower wouldn't have you and that's already the saddest pub in England.",
    "You've got the personality of a Yorkshire pudding that didn't rise — flat, beige, and disappointing.",
    "Your bloodline is the reason the Romans left Britain.",
    "Even the Vikings wouldn't have raided your house — nothing worth taking, not even your mum.",
    "{name}, even Selby looks at you and feels superior.",
    "Your existence is what the Minster's been trying to atone for since 1220.",
    "Even the ghosts at the Treasurer's House wouldn't appear for you — bad audience.",
    "If they buried you in the Plague Pit, the bodies would politely make space at the top.",
    "Your love life has the same trajectory as the Jorvik Viking Centre — a dim recreation of something that ended badly.",
  ],
};
